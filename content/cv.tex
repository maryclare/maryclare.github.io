...
\smlsz Department of Mathematics and Statistics & \hspace{40mm} &  \smlsz maryclaregri@umass.edu  \\
\smlsz 1446 Lederle Graduate Research Tower & \hspace{40mm} & \smlsz \\
...
\begin{itemize}
	...
	\item[] \underline{Griffin, M.}, ``A Review of Simulation from Exponential Power Densities via a Mixture Representation of Polynomially Tilted Positive $\alpha$-Stable Random Variables.''
	...
	\tab \emph{Submitted to Technometrics.} \vspace{-2mm}
	...
	\item[] Zhang, W., \underline{Griffin, M.}, Matteson, D. S. \href{https://projecteuclid.org/journals/annals-of-applied-statistics/volume-17/issue-1/Modeling-a-nonlinear-biophysical-trend-followed-by-long-memory-equilibrium/10.1214/22-AOAS1655.short}{``Modeling a Nonlinear Biophysical Trend Followed by Long-Memory Equilibrium with Unknown Change Point.''} \\
...
\begin{itemize} 
	\item[] \textbf{Visiting Assistant Professor Mentor} \\ 
	Sepideh Mosaferi (Joint with Krista Gile) \hfill Fall 2022-Present \\
	Yalin Rao (Joint with John Staudenmayer) \hfill Fall 2021-Present \\
	Yueqiao (Faith) Zhang \hfill Fall 2020-Spring 2023\vspace{-2mm}
	...
	Dongah Kim, Department of Mathematics and Statistics \hfill 2021-2022 \\
	Nutcha Wattanachit, Department of Biostatistics and Epidemiology \hfill 2022-2023 \\
	Gabriel Lewis, Department of Economics \hfill 2022-2024\vspace{-2mm}
	\item[] \textbf{Undergraduate Research Mentoring} \\ 
	Daayisha Daga, Mount Holyoke College \hfill Summer 2021 \\
	Thyra Tuttle, UMass Amherst \hfill Spring 2021 \\
\end{itemize}
