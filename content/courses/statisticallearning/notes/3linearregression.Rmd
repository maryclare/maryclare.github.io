...
\begin{align*}
\text{Var}[\hat{\beta}_0] = \sigma^2\left(\frac{1}{n} + \frac{\bar{x}^2}{\sum_{i = 1}^n (x_i - \bar{x})^2}\right)\text{, \quad}\text{Var}[\hat{\beta}_1] = \sigma^2\left(\frac{1}{\sum_{i = 1}^n (x_i - \bar{x})^2}\right).
\end{align*}
...
\begin{align*}
\text{SE}[\hat{\beta}_0]^2 = \left(\frac{\text{RSS}}{n-2}\right)\left(\frac{1}{n} + \frac{\bar{x}^2}{\sum_{i = 1}^n (x_i - \bar{x})^2}\right)\text{, \quad}\text{SE}[\hat{\beta}_1]^2 = \left(\frac{\text{RSS}}{n-2}\right)\left(\frac{1}{\sum_{i = 1}^n (x_i - \bar{x})^2}\right).
\end{align*}
...
\end{align*}
with respect to $b_0, b_1, \dots, b_p$. Importantly, there is only a unique minimizer of the least squares criterion when $p < n$, i.e. we have more observations than predictors, and when the predictors $\boldsymbol x_1, \dots, \boldsymbol x_p$ aren't too correlated with each other.
