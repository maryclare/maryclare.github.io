...
## Why are we still coding given that generative AI exists?

Generative AI is a tremendously helpful accelerator, but it is not foolproof and needs to be checked.

Without understanding the basics, it's going to be very hard to check your code.
...
The `seq` function with first argument `0`, second argument `1`, and `length.out = 100` creates a **vector** with $100$ elements, where the value of the $k$-th element is $(k-1)/99$.
