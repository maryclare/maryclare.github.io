...
In this following, you will be asked to work with the gamma distribution. I recommend Wikipedia as a reference, `https://en.wikipedia.org/wiki/Gamma_distribution`. 
You may find it useful to refer back to the previous problem set and/or solutions. Additionally, complete the associated prompt that is part of the Canvas submission related to reading the article "History of Uniform Random Number Generation," posted on Canvas. 
