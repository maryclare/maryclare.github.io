...
In this following, you will be asked to work with the gamma distribution. I recommend Wikipedia as a reference, `https://en.wikipedia.org/wiki/Gamma_distribution`. Keep your rendered `.pdf` to no more than 1 page. Additionally, complete the associated prompt that is part of the Canvas submission related to reading the article "High-Performance Statistical Computing (HPSC): Challenges, Opportunities, and Future Directions," posted on Canvas. 
...
3. Provide the equation for the CDF of the gamma function for general shape and rate parameters $\alpha$ and $\lambda$. You may find this reference helpful if you are new to typesetting math, specifically Greek letters: `https://en.wikibooks.org/wiki/LaTeX/Mathematics#Greek_letters`.
